<div class="wrap welcome-wrap">
    <h1>Welcome To <?php echo $this->plugin_name;?> - All Bulk SMS</h1>
		...
		<div class="">
			<div id="poststuff">
				<div id="postbox-container-1" class="postbox-container">
					...
					<h1 class="hndle"><span>FOR SMS Integration Guide<a href="https://www.allbulksms.in/contact-form-7-sms-integration.html" target="_blank" style="font-size:30px;" >CLICK HERE</a></span></h1> 
						<h1 class="hndle"><span>FOR FREE SMS DEMO <a href="http://tsms.allbulksms.in/Registration.aspx" target="_blank" style="font-size:30px;" >CLICK HERE</a></span></h1> 
						<div class="option">
							<div id="mc_embed_signup">
						<a href="https://www.allbulksms.in/"><img src="https://www.allbulksms.in/images/banner-cf7.jpg" /></a>
							</div>
						</div>
					</div>
				</div>
